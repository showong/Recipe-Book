...
Do NOT invent a new card layout. Copy the structure from Image 1 exactly.`;
    ...
    if (type === "step-instagram") {
      ...
      const bearFile =
        (character === "lazy_bear" || character === "lazy") ? "chef-bear-reference-1.png" :
        (character === "trend_bear" || character === "trend") ? "chef-bear-reference-2.png" :
        "chef-bear-reference.png"; // cute_bear default
